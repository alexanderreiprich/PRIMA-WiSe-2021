namespace L10_Doom_AI {
  ...
  async function hndEnemy(): Promise<fc.Node> {
    ...
    enemies.appendChild(new Enemy("Hellknight0", new fc.Vector3(10, 0, -10)));
    enemies.appendChild(new Enemy("Hellknight1", new fc.Vector3(-10, 0, -10)));
    enemies.appendChild(new Enemy("Hellknight2", new fc.Vector3(-10, 0, 10)));
